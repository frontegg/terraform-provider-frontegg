...
- `machine_to_machine_auth_strategy` (String) Type of tokens users will be able to generate - used only when api tokens are enabled.

Must be one of "ClientCredentials" or "AccessToken". Defaults to "ClientCredentials".
